...
export const Border = twc.div`border-t border-header-color-secondary py-5`
...
export const UlContainer = twc.ul`flex gap-8 justify-center md:justify-between text-footer-nav-links flex-wrap px-6 items-center md:flex-grow`
