...
export const LogoRoot = twc.header`flex flex-row gap-4 items-center`
export const HeaderRoot = twc.header`w-full py-header-py bg-header-color px-5 md:px-0`
...
export const HeaderCenter = twc.div`flex-1 mx-10`
