export default function LogoTriste(props: any) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      />
      <path
        d="M367.455 482.149C353.655 502.15 330.58 515.258 304.442 515.258C277.38 515.258 253.6 501.206 240 480C245.527 510.294 272.053 533.258 303.942 533.258C335.073 533.258 361.092 511.373 367.455 482.149Z"
        fill="currentColor"
      />
      <path
        d="M559.455 483.149C545.655 503.15 522.58 516.258 496.442 516.258C469.38 516.258 445.6 502.206 432 481C437.527 511.294 464.053 534.258 495.942 534.258C527.073 534.258 553.092 512.373 559.455 483.149Z"
        fill="currentColor"
      />
    </svg>
  )
